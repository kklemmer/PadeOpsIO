...
def get_key(): 
    ...
    key = {  # BUDGET 0 TERMS: (1st and second order averages, scalars excluded)
        ...
        'uu_pressure_strain':               (4,4),
        'uu_pressure_transport':            (4,5),
        ...
        'vv_pressure_strain':               (4,14),
        'vv_pressure_transport':            (4,15),
        ...
        'ww_pressure_strain': (4,24),
        'ww_pressure_transport': (4,25),
        ...
        'uw_pressure_strain': (4,34),
        'uw_pressure_transport': (4,35),
        ...
        'vw_pressure_strain': (4,44),
        'vw_pressure_transport': (4,45),
